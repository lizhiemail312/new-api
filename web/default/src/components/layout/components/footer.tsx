...
export function Footer(props: FooterProps) {
  ...
  const displayName = systemName || props.name || 'APiBay'
        ...
        links: [
          {
            ...
            href: 'https://apibay.ai/claude-code',
          },
          {
            text: t('footer.columns.about.links.contact'),
            href: 'mailto:support@apibay.ai',
          },
          {
            text: t('footer.columns.about.links.features'),
            href: 'https://apibay.ai/#features',
          },
        ],
      },
      {
